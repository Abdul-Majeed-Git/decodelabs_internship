...
4. Navigate to the directory where the file is located using 'cd [your file name]' command.
5. Run the program using the command: "python expensetracker.py"
...
-> Select 2 from menu to view the total and exit the program.
